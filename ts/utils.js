...
function findAssociatedStakeInfoAddress(poolId, walletAddress, programId) {
    return __awaiter(this, void 0, void 0, function* () {
        let [_associatedStakerSeed, _associatedStakerSeedNonce] = yield anchor.web3.PublicKey.findProgramAddress([poolId.toBuffer(), walletAddress.toBuffer(), Buffer.from('staker_info_v2_associated_seed')], programId);
